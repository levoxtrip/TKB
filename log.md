# Weekly Log - 2024-10-09 17:35:08 UTC

List of newly created Markdown files in the last week from the docs folder:

## # Animate through graph of datapoints
  - First image: ![](https://levoxtrip.github.io/TKB/topics/topics/TouchDesigner/CHOPS/AnimateThroughDataPoints/img/AnimateThroughData0.png)
...
## # Hold last changed value
  - First image: ![](https://levoxtrip.github.io/TKB/topics/topics/TouchDesigner/CHOPS/HoldLastChangedValue/img/HoldLastChangedValue.png)
...
## # Map CHOP to SOP length
  - First image: ![](https://levoxtrip.github.io/TKB/topics/topics/TouchDesigner/CHOPS/MapCHOPtoSOPLength/img/MapCHOPtoSOPLength.png)
...
## # Measure how fast the CHOP value changes
  - First image: ![](https://levoxtrip.github.io/TKB/topics/topics/TouchDesigner/CHOPS/MeasureChangeOfValue/img/MeasureSpeedValChange.png)
...
## # Stretch CHOP to specific numSamples
  - First image: ![](https://levoxtrip.github.io/TKB/topics/topics/TouchDesigner/CHOPS/StretchCHOPToNumSamples/img/StretchCHOPToNumSamples.png)
...
## # ExecuteDAT when new selection from table
  - First image: ![](https://levoxtrip.github.io/TKB/topics/topics/TouchDesigner/DATS/ExecuteNewSelectionTable/img/ExecuteNewSelectionTable0.png)
...
## # Populate TableDAT via Script
  - First image: ![](https://levoxtrip.github.io/TKB/topics/topics/TouchDesigner/DATS/PopulateTableDATViaScript/img/PopulateTableDATScript.png)
...
## # Swapping columns or rows in TableDAT
  - First image: ![](https://levoxtrip.github.io/TKB/topics/topics/TouchDesigner/DATS/SwappingColsRowsTable/img/SwappingColsRowsTable.png)
...
## # Get all values of CHOP as a list
  - First image: ![](https://levoxtrip.github.io/TKB/topics/topics/TouchDesigner/SCRIPTING/GetAllValuesChopAsList/img/getValuesChopAsList.png)
...
## # Displace Grid With MagnetSOP
  - First image: ![](https://levoxtrip.github.io/TKB/topics/topics/TouchDesigner/SOPS/DisplaceGridMagnetSOP/img/DisplaceGridByMagnet.png)
...
## # Change the Seed With a ClockCHOP
  - First image: ![](https://levoxtrip.github.io/TKB/topics/topics/TouchDesigner/TECHNIQUES/ChangeSeedWithClock/img/ChangeSeedWithClock.png)
...
## # Set custom Framerate for process in BaseCOMP
  - First image: ![](https://levoxtrip.github.io/TKB/topics/topics/TouchDesigner/TECHNIQUES/SetCustomFrameRateProcess/img/SetCustomFrameRate1.png)
...
## # Change values for locked visuals
  - First image: ![](https://levoxtrip.github.io/TKB/topics/topics/TouchDesigner/TOPS/ChangeValuesLockedTOP/img/ChangeVisualsLockedTOP.png)
...
## # Image Instancing On Grid
  - First image: ![](https://levoxtrip.github.io/TKB/topics/topics/TouchDesigner/TOPS/ImageInstancingOnGrid/img/ImageInstancingGrid0.png)
...
## # Set Text from tableDAT
  - First image: ![](https://levoxtrip.github.io/TKB/topics/topics/TouchDesigner/TOPS/SetTextTOPFromTableDAT/img/SetTextTOPFromTableDAT.png)
